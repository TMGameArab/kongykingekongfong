...
if (message.content.startsWith(prefix + "cv")) {
  ...
  if (message.content === 'السلام وعليكم') {
...
message.channel.sendEmbed(embed);
    ...
    if (message.content === 'العمر') {
      message.reply('**اجابه صحيحه**');
    }else
        if (message.content === 'الملح') {
          message.reply('**اجابه صحيحه**');
    }else
    if (message.content === 'السكر') {
      message.reply('**اجابه صحيحه**');
    }else
    if (message.content === 'مشط') {
      message.reply('**اجابه صحيحه**');
    }else
    if (message.content === 'قاتل نفسه') {
      message.reply('**اجابه صحيحه**');
    }
 ...
 .addField('لعبه اسرع كتابه' ,
  ...
  if (message.content === 'شفتك شفتني ماشفتك ماشفتني') {
    message.reply('**مشالله عليك اسرع واحد**');
  }
